...
public class EmailController {
	...
	public ResponseEntity<?>  queuing(@RequestBody ArrayOfData ex, @PathVariable String sender, @PathVariable String receiver, @PathVariable int id) {
		try {
			...
			return new ResponseEntity<String>("Email failed",HttpStatus.NOT_FOUND);
		}
 	}
	...
	@GetMapping("/email/{id}")
	public ResponseEntity<Email> get(@PathVariable Integer id) {
		try {
			Email t = emailService.get(id);
			return new ResponseEntity<Email>(t,HttpStatus.OK);
